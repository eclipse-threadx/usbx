...
#define UX_DATA_MEMORY_BARRIER  __asm__ __volatile__("MCR p15, 0, r0, c7, c10, 4");
...
CHAR                            _ux_version_id[] = 
                                    "Copyright (c) Microsoft Corporation. All rights reserved. * USBX ARM9/GNU Version 6.1.12 *";
#else
