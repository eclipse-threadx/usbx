...
UINT                        status;
    ...
    status =  _ux_utility_semaphore_get(&prolific -> ux_host_class_prolific_semaphore, UX_WAIT_FOREVER);
    ...
    _ux_utility_semaphore_delete(&prolific -> ux_host_class_prolific_semaphore);
