...
UX_HOST_CLASS_PIMA_STORAGE_IDS_LENGTH_ASSERT
...
ULONG                                nb_storage_ids;
     ...
     * UX_HOST_CLASS_PIMA_STORAGE_IDS_LENGTH_ASSERT checks if calculation of
     * UX_HOST_CLASS_PIMA_STORAGE_IDS_LENGTH is OK.
     */
